...
#define ARRAY_STEP_SIZE (5) // Defining the step size for the random array
#define ARRAY_NUM_SIMS (2) // Defining the number of same length arrays for the random implementation
